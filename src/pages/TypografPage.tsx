                ...
                <Container>
                    ...
                    <div className="well panel-narrow">
                        <Row>
                            <Col md={12}>
                                <small>
                                    <p>Онлайн <strong>типограф</strong>. Очень полезен для быстрого форматирования текстов для публикации. Здесь вы можете <strong>сделать кавычки-ёлочки</strong>, <strong>заменить дефисы на тире</strong>, <strong>напечатать знак номера, копирайт и кружочек в списке</strong>. Автоматически удаляются лишние пробелы и отступы. Также доступны математические символы <strong>плюс минус</strong>, <strong>дроби</strong> и <strong>знак рубля, евро, гривны, тенге</strong> и других валют.
                                    </p>
